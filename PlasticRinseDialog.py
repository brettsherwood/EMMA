...
class PlasticRinseDialog(object):
    def setupPlasticRinse(self, Dialog):
        # Main Window
        ...
        self.btn_rinse.clicked.connect(self.openPlasticLid)
...
if __name__ == "__main__":
    ...
    ui = PlasticRinseDialog()
    ui.setupPlasticRinse(Dialog)
    Dialog.show()
    sys.exit(app.exec_())
